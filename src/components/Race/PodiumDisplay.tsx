  ...
  return (
    <Stack gap={2}>
      <FinishBadge
        finishingPosition={1}
        driver={
          data.find((x) => x.driver_number === raceResult[0].driver_number)!
        }
      />
      <FinishBadge
        finishingPosition={2}
        driver={
          data.find((x) => x.driver_number === raceResult[1].driver_number)!
        }
      />
      <FinishBadge
        finishingPosition={3}
        driver={
          data.find((x) => x.driver_number === raceResult[2].driver_number)!
        }
      />
    </Stack>
  );
